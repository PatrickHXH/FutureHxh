  ...
  <div class="app-container" style="height:calc(95vh)">
    <el-card style="width: 100%;height: 100%;">
      ...
      <el-table
        ...
        <el-table-column prop="sender" label="发送"></el-table-column>
        <el-table-column prop="receive" label="接收"></el-table-column>
        <el-table-column prop="report_time" label="报告时间"></el-table-column>
        <el-table-column prop="update_time" label="更新时间"></el-table-column>
        <el-table-column prop="create_time" label="创建时间"></el-table-column>
        <el-table-column prop="lastest" label="最新"></el-table-column>
  ...
  methods: {
    ...
    Search(formName) {
      this.$refs[formName].validate((valid) => {
          if (valid) {
            this.loading=true
            let reportdata ={"project_id":this.projectvalue,"email_id":this.emailvalue}
