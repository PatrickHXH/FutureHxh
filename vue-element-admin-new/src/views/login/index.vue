<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
      ...
      <!-- 游客模式 -->
      <el-button :loading="loading" type="success" style="width:100%;margin-left:0;margin-bottom:10px;color:antiquewhite;" @click="vistorclick()">游客模式</el-button>
